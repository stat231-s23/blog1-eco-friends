...
dq_table <- augment(dq_clusers_5, dq_nutrition)%>%
  pivot_wider(names_from = .cluster, values_from = item)

cluster_list <- split(dq_nutrition$item, dq_clusers_5$cluster)
#names(cluster_list) <- c("Cluster 1", "Cluster 2", "Cluster 3", "Cluster 4", "Cluster 5")
kable(cluster_list, col.names = paste("Cluster", 1:5))
