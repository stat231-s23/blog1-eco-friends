...
Our data is from Kaggle and was created for the purpose of analyzing the health of different fast food items. It can be found HERE, where you can view other variables that were not a part of our analysis if you are interested in exploring further.
